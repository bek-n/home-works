...
import 'package:home_works/17%20November.%20Alisher%20nanoiy%20page%20to%20page/ligh_mode%20menu.dart';
      ...
      home: Scaffold(
          ...
          leading: GestureDetector(
              onTap: () => {
                    Navigator.of(context).push(
                        MaterialPageRoute(builder: (_) => menuLightMode()))
                  },
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              Container(
                child: Image.asset('assets/rasm.png'),
              ),
              Text(
                'Alisher Navoiy ',
                style: TextStyle(
